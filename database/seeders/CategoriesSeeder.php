...
class CategoriesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('assetcategories')->insert([
            ...
            ['id' => 18, 'name' => 'Video Switcher', 'color' => '#007bff', 'classification_id' => 3, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['id' => 43, 'name' => 'Kompor', 'color' => '#007bff', 'classification_id' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['id' => 44, 'name' => 'Pompa Air', 'color' => '#007bff', 'classification_id' => 2, 'created_at' => now(), 'updated_at' => now()],
