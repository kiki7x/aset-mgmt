@extends('layouts.backsite', [
    ...
    'breadcrumb' => '<li class="breadcrumb-item"> <a href="' . route($classification_id == 2 ? 'admin.asettik' : 'admin.asetrt') . '">Aset ' . ($classification_id == 2 ? 'TIK' : 'RT') . '</a></li>' . '<li class="breadcrumb-item active">Detail Aset ' . ($classification_id == 2 ? 'TIK' : 'RT') . '</li>',
])
